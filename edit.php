...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Xử lý cập nhật sinh viên nếu có yêu cầu
    // Lấy dữ liệu từ form
    ...
    $sql_update = "UPDATE students SET fullName='$fullname', studentCode='$studentCode', phone='$phone', gender='$gender', email='$email', address='$address' WHERE id=$student_id";
